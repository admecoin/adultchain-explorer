...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title>Adultchain Explorer</title>
...
.container .button {
  ...
  <body>
    <div class="logo">
      <a href="//adultchain.me/">
        <img src="//adultchain.me/logo.png" title="Adultchain"/>
      </a>
      </div>
    <div class="container">
        <img src="https://media.giphy.com/media/vIDsZm5DMZ5Ha/giphy.gif" title="Sad Explorer."/>
      <h1>Maintenance</h1>
      <p>Adultchain Explorer is not available at this moment.<br/>Please check back later.</p><br/>
  <a href="//adultchain.me/" class="button">Back to Main</a>
      </div>
  </body>
</html>
  `);
